          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-xl bg-navy-950/50 border border-navy-800 text-xs font-mono space-y-2">
              ...
              <p className="text-slate-300">
                Evaluated on all 128 multi-hop test topologies using leave-one-out cross-case validation (no label leakage). Current measured Top-3 accuracy is 55.5% with a mean geodesic error of 5.37 km — see the TRL 3 Validation page for full, honestly-computed methodology and numbers.
              </p>
            </div>
          </div>
